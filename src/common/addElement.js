...
function removeBlock() {
  ...
  const mainInput = document.getElementById("removeElement");

  if (mainBlock.childNodes.length > mainInput.value) {
    document.getElementById("main").removeChild(document.getElementById("main").children[mainInput.value - 1]);
  }
}
